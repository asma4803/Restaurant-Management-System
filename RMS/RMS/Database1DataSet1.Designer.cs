...
namespace RMS.Database1DataSet1TableAdapters {
    ...
    public partial class ReservationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Reservation] WHERE (([tableNo] = @Original_tableNo) AND ([noOf" +
                "Chairs] = @Original_noOfChairs) AND ([res_date] = @Original_res_date))";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Reservation] SET [tableNo] = @tableNo, [noOfChairs] = @noOfChairs, [res_date] = @res_date WHERE (([tableNo] = @Original_tableNo) AND ([noOfChairs] = @Original_noOfChairs) AND ([res_date] = @Original_res_date));
SELECT tableNo, noOfChairs, res_date FROM Reservation WHERE (tableNo = @tableNo)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT tableNo, noOfChairs, res_date FROM dbo.Reservation";
        ...
        public virtual int Fill(Database1DataSet1.ReservationDataTable dataTable) {
        ...
        public virtual Database1DataSet1.ReservationDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Database1DataSet1.ReservationDataTable dataTable = new Database1DataSet1.ReservationDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Database1DataSet1.ReservationDataTable dataTable) {
