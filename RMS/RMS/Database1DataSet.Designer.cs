...
namespace RMS {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class ReservationDataTable : global::System.Data.TypedTableBase<ReservationRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public ReservationRow AddReservationRow(int tableNo, int noOfChairs, System.DateTime res_date, int cust_id) {
...
namespace RMS.Database1DataSetTableAdapters {
    ...
    public partial class ReservationTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Reservation] WHERE (([tableNo] = @Original_tableNo) AND ([noOf" +
                "Chairs] = @Original_noOfChairs) AND ([res_date] = @Original_res_date) AND ([cust" +
                "_id] = @Original_cust_id))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Reservation] ([tableNo], [noOfChairs], [res_date], [cust_id]) " +
                "VALUES (@tableNo, @noOfChairs, @res_date, @cust_id);\r\nSELECT tableNo, noOfChairs" +
                ", res_date, cust_id FROM Reservation WHERE (tableNo = @tableNo)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@noOfChairs", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, 0, 0, "noOfChairs", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Reservation] SET [tableNo] = @tableNo, [noOfChairs] = @noOfChairs, [res_date] = @res_date, [cust_id] = @cust_id WHERE (([tableNo] = @Original_tableNo) AND ([noOfChairs] = @Original_noOfChairs) AND ([res_date] = @Original_res_date) AND ([cust_id] = @Original_cust_id));
SELECT tableNo, noOfChairs, res_date, cust_id FROM Reservation WHERE (tableNo = @tableNo)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::RMS.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT tableNo, noOfChairs, res_date, cust_id FROM dbo.Reservation";
        ...
        public virtual int Delete(int Original_tableNo, int Original_noOfChairs, System.DateTime Original_res_date, int Original_cust_id) {
        ...
        public virtual int Insert(int tableNo, int noOfChairs, System.DateTime res_date, int cust_id) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(tableNo));
            this.Adapter.InsertCommand.Parameters[1].Value = ((int)(noOfChairs));
            this.Adapter.InsertCommand.Parameters[2].Value = ((System.DateTime)(res_date));
        ...
        public virtual int Update(int tableNo, int noOfChairs, System.DateTime res_date, int cust_id, int Original_tableNo, int Original_noOfChairs, System.DateTime Original_res_date, int Original_cust_id) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_tableNo));
            this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(Original_noOfChairs));
            this.Adapter.UpdateCommand.Parameters[6].Value = ((System.DateTime)(Original_res_date));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int noOfChairs, System.DateTime res_date, int cust_id, int Original_tableNo, int Original_noOfChairs, System.DateTime Original_res_date, int Original_cust_id) {
            return this.Update(Original_tableNo, noOfChairs, res_date, cust_id, Original_tableNo, Original_noOfChairs, Original_res_date, Original_cust_id);
        }
    }
